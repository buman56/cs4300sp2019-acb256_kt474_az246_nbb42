...
def search():
	...
	return render_template('search.html',test = test, name=project_name, netid=net_id, output_message=output_message, data=data, top_result = top_result, description = description)
